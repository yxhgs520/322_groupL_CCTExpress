...
from .models import (
    ...
    DiscussionPost, KnowledgeBase, DeliveryBid
)
...
class DishAdmin(admin.ModelAdmin):
    """Dish management"""
    list_display = ('name', 'price', 'chef', 'is_vip_only', 'is_available', 'created_at')
...
class OrderAdmin(admin.ModelAdmin):
    """Order management"""
    list_display = ('id', 'customer', 'status', 'total_amount', 'vip_discount', 'delivery_person', 'created_at')
    list_filter = ('status', 'created_at', 'customer__is_vip')
    search_fields = ('customer__user__username', 'customer__user__email')
    readonly_fields = ('created_at', 'updated_at', 'customer', 'total_amount', 'vip_discount')
    list_editable = ('status',)
    actions = ['set_status_pending', 'set_status_confirmed', 'set_status_preparing', 'set_status_ready', 'set_status_out_for_delivery', 'set_status_delivered', 'set_status_cancelled']
    ...
    def set_status_preparing(self, request, queryset):
        """Set selected orders to preparing"""
        queryset.update(status='preparing')
        self.message_user(request, f"Set {queryset.count()} orders to preparing.")
    set_status_preparing.short_description = "Set status to Preparing"
...
class OrderItemAdmin(admin.ModelAdmin):
    ...
    list_display = ('order', 'dish', 'quantity', 'price', 'order_status')
...
class ComplaintAdmin(admin.ModelAdmin):
    ...
    list_display = ('title', 'complainant', 'status', 'created_at')
...
class ComplimentAdmin(admin.ModelAdmin):
    ...
    list_display = ('title', 'complimenter', 'status', 'created_at')
    list_filter = ('status', 'created_at')
...
class KnowledgeBaseAdmin(admin.ModelAdmin):
    ...
    list_display = ('question', 'author', 'is_flagged', 'created_at')
    list_filter = ('is_flagged', 'created_at')
    search_fields = ('question', 'answer', 'author__user__username')
    readonly_fields = ('created_at', 'updated_at')
